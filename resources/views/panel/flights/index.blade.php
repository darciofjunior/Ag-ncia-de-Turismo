...
<div class="content-din bg-white">
    ...
    <div class="form-search">
        {!! Form::open(['route' => 'flights.search', 'class' => 'form form-inline']) !!}
            ...
            {!! Form::time('hour_stop', null, ['class' => 'form-control']) !!}
        ...
        @forelse($flights as $flight)
            <tr>
                ...
                <td>
                    ...
                    @else
                        <img src="{{url("assets/panel/imgs/no-image.png")}}" alt="{{$flight->id}}" style="max-width: 80px;"/>
                    @endif
                </td>
                <td>
                    <a href="">
                ...
                <td>
                    ...
                    <a href="{{route('flights.show', $flight->id)}}" class="delete">Delete</a>
                </td>
            </tr>
        @empty
            <tr>
